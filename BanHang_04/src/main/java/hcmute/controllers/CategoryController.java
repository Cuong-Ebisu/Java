...
@WebServlet(urlPatterns = { "/web-listcate", "/addcate", "/update", "/delete" })
public class CategoryController extends HttpServlet {

	private static final long serialVersionUID = -8525451797506815235L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (url.contains("listcate")) {
			List<ProductModel> listcate = productService.orderByListProduct();
			// day du lieu ra view
			req.setAttribute("list2", listcate);
