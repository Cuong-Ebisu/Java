...
<div class="main-content">
	<div class="left-section">
		...
		<div class="menu-item">
			<a href="/user/dashboard/${userid }?countFriend=${countFriend}">
				<i class="fa fa-list-alt menu-icon"></i> <span class="menu-text">Thống
					kế User</span>
			</a>
		</div>
		...
		<div class="menu-item">
			<a href="/admin/alohcmute/profile/FriendRequestNotification"> <i
				class="fa fa-bookmark menu-icon"></i> <span class="menu-text">Xem
					tất cả thông báo</span>
			</a>
		</div>
		<div class="menu-item">
			<a href="/admin/alohcmute/profile"> <i
				class="fa fa-user menu-icon"></i> <span class="menu-text">Trang
					cá nhân</span>
			</a>
		</div>

		<div class="menu-item">
			<a href="/logout"> <i class="fa fa-user menu-icon"></i> <span
