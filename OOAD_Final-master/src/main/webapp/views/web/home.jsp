...
<section class="py-0">
	<div class="container">
		<!-- Background image -->
		<div class="rounded-3 p-3 p-sm-5" style="background-image: url(${URL}images/bg/01.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			<!-- Banner title -->
			<div class="row"> 
			...
			<!-- Booking from START -->
			<form class="bg-mode position-relative px-3 px-sm-4 pt-4 mb-4 mb-sm-0" action="findticket" method="get">
				...
				<div class="row g-4 position-relative">
					...
					<div class="col-lg-6">
						<ul class="nav nav-pills nav-pills-dark" id="pills-tab" role="tablist">
							<li class="nav-item" role="presentation">
								<button name="type" class="nav-link rounded-start rounded-0 mb-0 active" id="pills-one-way-tab" data-bs-toggle="pill" data-bs-target="#pills-one-way" type="button" role="tab" aria-selected="true">
									One Way
								</button>
							</li>
							<li class="nav-item" role="presentation">
								<button name="type" class="nav-link rounded-end rounded-0 mb-0 " id="pills-round-trip-tab" data-bs-toggle="pill" data-bs-target="#pills-round-trip" type="button" role="tab" aria-selected="false">
									Round Trip
								</button>
							</li>
						</ul>
					...
					<div class="col-lg-3 ms-auto">
						<div class="form-control-bg-light form-fs-md">
							<select class="form-select js-choice" name="class" required>
								<option selected disabled value="">Select class</option>
								<c:forEach items="${listtc}" var="tc">
									<option>${tc.nameTC}</option>
								</c:forEach>
							</select>
						</div>	
					</div>
					...
					<!-- Ticket Travelers -->
          			<div class="col-lg-3 ms-auto">
						<div class="form-control-bg-light form-fs-md">
							<input class="form-control border-primary" type="search" placeholder="Enter travelers number" aria-label="Search" name="number" required  oninvalid="this.setCustomValidity('Please enter travelers number!')" oninput="this.setCustomValidity('')">
              ...
              <div class="row g-4">
                  ...
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    ...
                    <select class="form-select js-choice" data-search-enabled="true" name="from_oneway" >
                      ...
                      <c:forEach items="${listap}" var="ap">
						<option>${ap.idAP} - ${ap.cityAP}</option>
                      </c:forEach>
                    </select>
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    ...
                    <input type="text" class="form-control flatpickr " data-date-format="d M Y" data-min-date="today" placeholder="Select date" name="departure_oneway">
                  </div>
                </div>
            ...
            <div class="tab-pane fade" id="pills-round-trip" role="tabpanel" aria-labelledby="pills-round-trip-tab">
              <div class="row g-4">
                ...
                <div class="col-md-6 col-xl-3">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    <label class="mb-1"><i class="bi bi-calendar me-2"></i>Departure</label>
                    <input type="text" class="form-control flatpickr" data-date-format="d M Y" data-min-date="today" placeholder="Select date"  name="departure_round" >
                  </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    ...
                    <input type="text" class="form-control flatpickr" data-date-format="d M Y" data-min-date="today" placeholder="Select date"  name="return_round" >
                  </div>
                </div>
...
<section class="pt-0 pt-lg-5">
	<div class="container">
		...
		<div class="row g-4">
			<c:forEach items="${aptop4}" var="top">
				...
				<div class="col-sm-6 col-lg-3">
					...
					<div class="card card-img-scale overflow-hidden bg-transparent">	
						...
						<div class="card-img-scale-wrapper rounded-3">
							<img src="${URL}images/airport/${top.imagePlace}" class="card-img" alt="">
						</div>
						...
						<div class="card-body px-2">
							...
							<div class="d-flex justify-content-center align-items-center">
								<h5 class="card-title"><a href="#" class="stretched-link">${top.cityAP}</a></h5>
							</div>
						</div>
					</div>
					<!-- Card END -->
	...
	<div class="container">
		<div class="row g-4 g-lg-5 justify-content-center">
			...
			<div class="col-sm-6 col-md-4 text-center position-relative">
				...
				<div class="px-4">
					<!-- Image -->
					<img src="${URL}images/element/step-3.svg" class="w-150px mb-3" alt="">
					<!-- Title -->
					<h5>Search Choice</h5>
			...
			<div class="col-sm-6 col-md-4 position-relative text-center pt-0 pt-lg-5">
				...
				<div class="px-4">
					<!-- Image -->
					<img src="${URL}images/element/step-2.svg" class="w-150px mb-3" alt="">
			...
			<div class="col-sm-6 col-md-4 text-center">
				<div class="px-4">
					<!-- Image -->
					<img src="${URL}images/element/step-1.svg" class="w-150px mb-3" alt="">
