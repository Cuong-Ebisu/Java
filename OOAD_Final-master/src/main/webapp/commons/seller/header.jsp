...
<c:url value="/seller" var="seller"></c:url>
<c:url value="/sign-out" var="sign-out"></c:url>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					<!-- Nav item Listing -->
					<li class="nav-item">
						<a class="nav-link" href="${seller}">Home</a>
					</li>
					...
					<li class="nav-item">
						<a class="nav-link" href="seller">Flight Manager</a>
					</li>
				</ul>
				<!-- Nav main menu END -->
			</div>
