	...
	<div class="container">
		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<ul class="navbar-nav m-auto">
				...
				<li class="nav-item"><a class="nav-link" href="category.html">Sản phẩm</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="product.html">Đăng nhập</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="product.html">Trang quản trị</a>
				</li>
