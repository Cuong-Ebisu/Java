...
public class CategoryDAOimpl implements ICategotyDAO{
	...
	public List<CategoryModels> findAll() {
		/*Truy vấn dữ liệu từ một cơ sở dữ liệu và trả về danh sách 
		các đối tượng CategoryModels*/
		...
		try {
			...
			e.printStackTrace();
			/*Nếu có ngoại lệ trong quá trình truy vấn hoặc xử lý dữ liệu
			 * thì nó sẽ được in ra thông qua e.printStackTrace()*/
		}
